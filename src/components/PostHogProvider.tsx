...
export const trackPremiumModalOpen = (trigger: 'queue_limit' | 'sync_limit' | 'search_limit' | 'general', location: string = 'room') => {
...
export const trackPremiumPurchaseClick = (plan: 'monthly' | 'lifetime', trigger: 'queue_limit' | 'sync_limit' | 'search_limit' | 'general') => {
