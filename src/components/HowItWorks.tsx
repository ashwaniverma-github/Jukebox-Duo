...
const steps = [
  {
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none"><rect x="8" y="16" width="32" height="20" rx="6" fill="#FF5A5F"/><rect x="16" y="24" width="16" height="4" rx="2" fill="#fff"/><rect x="20" y="30" width="8" height="2" rx="1" fill="#fff"/></svg>
    ),
    title: "Create & Share",
  ...
  {
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none"><rect x="8" y="12" width="32" height="24" rx="8" fill="#fff" fillOpacity="0.12"/><rect x="14" y="20" width="20" height="8" rx="4" fill="#FF5A5F"/><rect x="18" y="24" width="12" height="2" rx="1" fill="#fff"/></svg>
    ),
    title: "Search & Queue",
  ...
  {
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none"><circle cx="24" cy="24" r="20" fill="#fff" fillOpacity="0.12"/><polygon points="20,16 34,24 20,32" fill="#FF5A5F"/><rect x="12" y="22" width="4" height="4" rx="2" fill="#fff"/><rect x="32" y="22" width="4" height="4" rx="2" fill="#fff"/></svg>
    ),
    title: "Play in Sync",
