  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-gray-950 to-black text-white overflow-auto lg:overflow-hidden flex flex-col">
      ...
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 0 }}>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gray-800/10 rounded-full blur-3xl animate-pulse delay-[2000ms]" />
      </div>
                ...
                >
                  ...
                  {!premiumLoaded ? (
                    <div className="w-full px-4 py-2 flex items-center justify-start">
                      ...
                      <span className="pl-2 text-white font-medium">Loading...</span>
                    </div>
                  ) : isPremium ? (
          ...
          <div className="flex-1 flex flex-col justify-center px-6 lg:px-10 py-4 lg:py-6">
            <div className="max-w-2xl">
              ...
              <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-5 lg:p-6 shadow-2xl">
                ...
                <p className="text-gray-400 mb-4 text-sm"><span>Private sessions with loved ones - everyone gets to DJ</span></p>
