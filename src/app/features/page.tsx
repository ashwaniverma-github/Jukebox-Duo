...
export const metadata: Metadata = {
  title: 'Features - Jukebox Duo | Listen to Music Together Online',
  description: 'Discover Jukebox Duo features: real-time synchronized playback, collaborative playlists, YouTube integration, and more. The best way to listen to music with friends online.',
  keywords: ['listen to music together', 'synchronized music playback', 'collaborative playlist', 'music listening room', 'listen with friends online'],
  alternates: {
    canonical: 'https://jukeboxduo.com/features',
  },
};
      ...
      <main className="relative z-10 px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <AnimatedSection delay={0.1} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            ...
            <AnimatedSection delay={0.2} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-gradient-to-br from-red-700 to-red-500 rounded-xl flex items-center justify-center mb-4">
            ...
            <AnimatedSection delay={0.3} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-gradient-to-br from-red-700 to-red-500 rounded-xl flex items-center justify-center mb-4">
            ...
            <AnimatedSection delay={0.4} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-gradient-to-br from-red-700 to-red-500 rounded-xl flex items-center justify-center mb-4">
            ...
            <AnimatedSection delay={0.5} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-gradient-to-br from-red-700 to-red-500 rounded-xl flex items-center justify-center mb-4">
            ...
            <AnimatedSection delay={0.6} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="w-12 h-12 bg-gradient-to-br from-red-700 to-red-500 rounded-xl flex items-center justify-center mb-4">
